...
- Always close any processes and browser instances you start (dev servers, `preview`, headless Chrome, long-running watchers) once the task is done. Leave no orphaned processes or open ports behind.
