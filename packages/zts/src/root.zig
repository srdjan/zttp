...
pub const PrepareSourceDiagnostic = engine.source_frontend.PrepareDiagnostic;
pub const PrepareSourceDiagnosticKind = engine.source_frontend.PrepareDiagnosticKind;
