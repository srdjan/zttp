...
const verifier_meta = [_]struct {
    ...
    .{
        ...
        .example = "structural Guardrails = Spec<\"idempotent\">; function handler(req): Response & Guardrails { return Response.json({ now: Date.now() }); }",
    ...
    .{
        ...
        .example = "structural G = Spec<\"read_only\">; import { cacheSet } from 'zttp:cache'; // write violates read_only",
    ...
    .{
        ...
        .example = "structural G = Spec<\"made_up\">;",
