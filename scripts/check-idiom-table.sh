...
# The row count measured on 2026-08-16 after template interpolation, string
# addition, and declaration destructuring left the language. Removed forms are
# restrictions, not non-idiomatic alternatives.
MIN_ROWS=18
